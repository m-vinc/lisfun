...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.ExternalUserID(); !ok {
		return &ValidationError{Name: "external_user_id", err: errors.New(`db: missing required field "User.external_user_id"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
// UpdateExternalUserID sets the "external_user_id" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateExternalUserID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
...
// UpdateExternalUserID sets the "external_user_id" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateExternalUserID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateExternalUserID()
	})
}
