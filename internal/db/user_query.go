...
func (uq *UserQuery) loadTokens(ctx context.Context, query *TokenQuery, nodes []*User, init func(*User), assign func(*User, *Token)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(token.FieldID), joinT.C(user.TokensPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.TokensPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.TokensPrimaryKey[0]))
